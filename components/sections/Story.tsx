const PILLARS = [
  {
    ...
    body:
      "Visitamos cada vivero y elegimos ejemplar por ejemplar. Si la planta no está sana y aclimatada, no va al catálogo.",
  },
  {
    n: "02",
    title: "Aluminio para siempre",
    body:
      "Nuestras macetas se fabrican localmente en aluminio cepillado: no se oxida, no se rompe, no amarillea. Durables de verdad.",
  },
  {
    n: "03",
    title: "Envío cuidado",
    body:
      "Embalaje diseñado planta por planta, coordinado con vos. Si algo no llega bien, lo reponemos sin discusión.",
  },
]
        ...
        <div className="reveal grid grid-cols-1 gap-14 lg:grid-cols-12">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 lg:col-span-7">
            {PILLARS.map((p) => (
              ...
              >
                <span className="font-display text-3xl italic text-moss">{p.n}</span>
